...
class CustomTabBarController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        let revealingSplashView = RevealingSplashView(iconImage: UIImage(named: "logo2")!, iconInitialSize: CGSize(width: 333, height: 129), backgroundColor: UIColor(red: 35/255, green: 183/255, blue: 159/255, alpha: 1.0))
